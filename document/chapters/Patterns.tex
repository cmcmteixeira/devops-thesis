\chapter{ Patterns from the Portuguese Startup Scene} \label{chap:patterns}
		...
		\begin{pattern}{Team Orchestration}
				\context{Budgets, customer needs, users numbers and other types constraints evolve at a fast pace. In order to be effective in this kind of environment, you want your teams to be able to adapt and respond quickly to those changes.}
				...
				In terms of \textbf{size}, this teams should not go beyond 10 elements. This constraint comes from the need that multidisciplinary teams have to be able to communicate effectively. Team members should be seen as equals and no hierarchical structure should be imposed inside the team.
		...
		\begin{pattern}{Communication}
				\context{Each member of a multidisciplinary team have different knowledge and backgroud that differ from each other.
